    ...
    return (
        <div className="space-y-12 pb-20">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 text-left">
                {/* Left Column */}
                <div className="lg:col-span-2 -mt-6 space-y-4">
                    ...
                    <div className="bg-white rounded-xl border-t-2 shadow-soft px-8 pt-4 pb-4">
                        ...
                        <div className="flex gap-4 overflow-x-auto snap-x snap-mandatory scrollbar-hide pb-4">
                            {upcomingExams.length > 0 ? upcomingExams.map((exam, idx) => {
                                ...
                                return (
                                    <div key={idx} className="min-w-[280px] max-w-[320px] flex-shrink-0 p-4 rounded-3xl bg-red-50/50 hover:bg-white hover:shadow-lg transition-all group snap-start border border-red-100/50">
                    ...
                    <div className="bg-white rounded-xl shadow-soft px-10 pt-4 pb-4">
                        <div className="flex items-center justify-between mb-4">
                            <h2 className="text-fluid-2xl font-black text-slate-900 tracking-tight flex items-center gap-3">
                            ...
                            <div className="text-xs font-bold uppercase text-slate-400 tracking-widest">Pending Tasks</div>
                        </div>

                        <div className="flex gap-4 overflow-x-auto snap-x snap-mandatory scrollbar-hide pb-2">
                            {pendingHomework.length > 0 ? pendingHomework.map((hw, idx) => (
                                <div key={idx} className="min-w-[280px] max-w-[320px] h-52 flex-shrink-0 px-6 pt-4 pb-0 rounded-lg bg-amber-50/50 hover:bg-white hover:shadow-lg transition-all group snap-start border border-amber-100/50">

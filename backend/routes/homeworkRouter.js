...
const { createHomework, getHomework, updateHomeworkStatus, updateHomework, getHomeworkSubmissions } = require("../controllers/homeworkController");
...
router.get("/submissions/:homeworkId", auth, authorizeRole(...teacherRoles), getHomeworkSubmissions);
